...
def video_reader_thread():
    ...
    # Camera source replacing the old MP4 source.
    # This uses the same settings as your working MMlove stereo camera test.
    CAMERA_INDEX = 0


    cap = cv2.VideoCapture(CAMERA_INDEX)

    # Stereo camera outputs one wide side-by-side frame.
    # 2560x720 = 1280x720 left camera + 1280x720 right camera.
    ...
    print("Stereo camera opened successfully.")
    print("Using LEFT camera feed for edge detection.")
    ...
    while video_running:
        ...
        # Split stereo image into left/right, exactly like your working camera test.
        left_frame = frame[:, :mid]
        # right_frame = frame[:, mid:]  # Available if you want to switch later.
        ...
        with frame_lock:
            frame_queue.clear()
            frame_queue.append(left_frame.copy())
